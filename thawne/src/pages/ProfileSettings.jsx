...
function Settings() {
  ...
  return (
    <div class="grid grid-cols-8 pt-3 sm:grid-cols-10 text-white">
      <div class="col-span-2 hidden sm:block">
        <ul>
          <li class="mt-5 cursor-pointer border-l-2 border-l-gray-700 px-2 py-2 font-semibold text-gray-700 transition hover:border-l-gray-700 hover:text-gray-700">
            Profile
          </li>
          <li class="text-gray-600 mt-5 cursor-pointer border-l-2 border-transparent px-2 py-2 font-semibold transition hover:border-l-gray-700 hover:text-gray-700">
            Notification
          </li>
          <li class="text-gray-600 mt-5 cursor-pointer border-l-2 border-transparent px-2 py-2 font-semibold transition hover:border-l-gray-700 hover:text-gray-700">
            Data
      ...
      <div class="col-span-8 overflow-hidden rounded-xl sm:px-8 sm:shadow">
        <div class="pt-4">
          <h1 class="py-2 text-2xl font-semibold text-gray-600">
            Account settings
          </h1>
        </div>
        <hr class="mt-4 mb-8" />
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          ...
          <button class="inline-flex text-sm font-semibold text-white bg-gray-700 underline decoration-2">
            Change
          </button>
        </div>
        <hr class="mt-4 mb-8" />
        ...
        <div class="mb-10">
          ...
          <button class="ml-auto text-sm font-semibold text-rose-600 bg-red-200 underline decoration-2">
